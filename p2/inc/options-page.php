...
class P2_Options {
	...
	static function page() {
		...
		if ( isset( $_POST[ 'action' ] ) && esc_attr( $_POST[ 'action' ] ) == 'update' ) {
			...
			if ( esc_attr( $_POST[ 'p2_prompt_text' ] ) != __( "What's happening?" ) )
			...
			<table class="form-table">
				<tbody>
					...
					<tr valign="top">
						...
						<td>
							<input id="p2_prompt_text" type="input" name="p2_prompt_text" value="<?php echo ($p2_prompt_text_val == __("What's happening?") ) ? __("What's happening?") : stripslashes( $p2_prompt_text_val ); ?>" />
